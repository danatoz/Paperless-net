...
/// <summary>
/// Request body for POST /api/correspondents/.
/// </summary>
...
/// <summary>
/// Request body for PUT /api/correspondents/{id}/ (full update).
/// </summary>
...
/// <summary>
/// Request body for PATCH /api/correspondents/{id}/ (partial update).
/// All fields are optional — only provided fields will be updated.
/// </summary>
public class PatchCorrespondentRequest
{
    [JsonPropertyName("name")]
...
/// <summary>
/// Query parameters for GET /api/correspondents/.
/// </summary>
public class CorrespondentFilterRequest
{
    /// <summary>
